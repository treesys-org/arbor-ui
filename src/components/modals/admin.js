                            ...
                            : `<div class="space-y-2">
                                ${folderGuardians.map(r => `
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm">
                                        ...
                                        <button data-action="revoke-guardian" data-owner="${r.owner}" class="w-8 h-8 flex items-center justify-center text-slate-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">✕</button>
                                    </div>
                                `).join('')}
                               </div>`
                        }
